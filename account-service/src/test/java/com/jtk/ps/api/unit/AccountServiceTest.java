...
//        Mockito.verify(lecturerRepository, Mockito.times(1)).save(new Lecturer(0, registerRequest.getName(), EProdi.D3, null));
...
//        Mockito.when(lecturerRepository.findByAccountId(any(Integer.class))).thenReturn(Optional.of(new Lecturer(1, "Dosen A", EProdi.D3, new Account(1, "panitiad3", "1234", ERole.COMMITTEE), null)));
//
//        accountService.updateAccount(updateAccountRequest);
//
//        Mockito.verify(lecturerRepository, Mockito.times(1)).save(new Lecturer(1, "Dosen B", EProdi.D3, new Account(1, "panitiad3", "1234", ERole.COMMITTEE), null));
...
//        String cookie = "cookie";
//
//        Lecturer lecturer = new Lecturer(1, "Dosen A", EProdi.D3, account, null);
...
//
//        Mockito.verify(lecturerRepository, Mockito.times(1)).delete(new Lecturer(1, "Dosen A", EProdi.D3, account, null));
