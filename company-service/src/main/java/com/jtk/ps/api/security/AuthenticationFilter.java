...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        try {
            ...
            String requestURL = String.valueOf(new StringBuilder(request.getRequestURI()));

            HttpStatus statusCode;
            ResponseEntity<VerifyResponse> verifyResponse = null;

            if (Objects.equals(requestURL, "/company/criteria") || Objects.equals(requestURL, "/company/submission/create")){
